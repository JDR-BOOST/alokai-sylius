<template>
  <div class="flex justify-center items-center h-screen">
    <div class="p-5 w-96">
      ...
      <p class="text-gray-50">boilerplate/updateCartItemQuantity</p>
      <div class="box">
...
const res = useState(
  ...
  () => "waiting to call updateCartItemQuantity() ..."
);

async function callEndpoint() {
  const { data } = await sdk.boilerplate.updateCartItemQuantity("test");
  res.value = data;
}
